...
//ASUS_BSP Ken_Gan +++ [BSP][Scorpio][BootInfo][Porting]Provide BootInfo for Scorpio
...
extern int g_ASUS_RF_SKU;
extern int g_ASUS_MEM_ID;
extern int g_ASUS_PRJ_STAGE;
extern int g_ASUS_PRJ_CPUTYPE;
...
void oem_get_memory_str(struct seq_file *s)
{
	const char* emmc_name = "UNKNOWN";
	const char* ddr_name = "UNKNOWN";

	if(EVB_PMI8952 == g_ASUS_PRJ_ID || EVB_PMI8937 == g_ASUS_PRJ_ID){
		switch(g_ASUS_MEM_ID){
			case HYNIX_8G_1G:
				emmc_name = "Hynix 8G/1G";
				break;
			case HYNIX_8G_2G:
				emmc_name = "Hynix 8G/2G";
				break;
			case HYNIX_16G_1G:
				emmc_name = "Hynix 16G/1G";
				break;
			case HYNIX_16G_2G:
				emmc_name = "Hynix 16G/2G";
				break;
			case SAMSUNG_16G_1G:
				emmc_name = "SAMSUNG 16/1G";
				break;
			case SAMSUNG_8G_2G:
				emmc_name = "SAMSUNG 8G/2G";
				break;
			case SAMSUNG_8G_1G:
				emmc_name = "SAMSUNG 8G/1G";
				break;
			case SAMSUNG_16G_2G:
				emmc_name = "SAMSUNG 16G/2G";
				break;
			default:
				emmc_name = "Unknown";
				break;
		}
		seq_printf(s, "Memory: %s\n", emmc_name);
	}else if(PRJ_CAPRICORN_10W== g_ASUS_PRJ_ID || PRJ_CAPRICORN_5W== g_ASUS_PRJ_ID){
		switch(g_ASUS_MEM_ID){
			case SAMSUNG_64G_3G:
				emmc_name = "SAMSUNG 64G/3G";
				break;
			case SAMSUNG_32G_3G:
				emmc_name = "SAMSUNG 32G/3G";
				break;
			case SAMSUNG_16G_3G:
				emmc_name = "SAMSUNG 16G/3G";
				break;
			case HYNIX_64G_3G:
				emmc_name = "HYNIX 64G/3G";
				break;
			case HYNIX_32G_3G:
				emmc_name = "HYNIX 32G/3G";
				break;
			case HYNIX_16G_3G:
				emmc_name = "HYNIX 16G/3G";
				break;
			case SAMSUNG_16G_2G_EVB:
				emmc_name = "SAMSUNG 16G/2G";
				break;
			default:
				emmc_name = "Unknown";
		...
		switch(g_ASUS_MEM_ID >> 3){
			case EMMC_SAMSUNG_64G:
				emmc_name = "SAMSUNG 64G";
				break;
			case EMMC_SAMSUNG_32G:
				emmc_name = "SAMSUNG 32G";
				break;
			case EMMC_SAMSUNG_16G:
				emmc_name = "SAMSUNG 16G";
				break;
			case EMMC_TOSHIBA_32G:
				emmc_name = "TOSHIBA 32G";
				break;
			case EMMC_TOSHIBA_16G:
				emmc_name = "TOSHIBA 16G";
				break;
			case EMMC_HYNIX_32G:
				emmc_name = "HYNIX 32G";
				break;
		...
		seq_printf(s, "Memory: %s/%s\n", emmc_name, ddr_name);
	}
}

void oem_get_soc_info_str(struct seq_file *s)
{
	const char* soc_type = "UNKNOWN";
	switch(g_ASUS_PRJ_ID){
		case EVB_PMI8937:
			soc_type = "MSM8937_PMI8937";
			break;
		case EVB_PMI8952:
			soc_type = "MSM8937_PMI8952";
			break;
		case PRJ_CAPRICORN_10W:
			soc_type = "Capricorn(10W)";
			break;
		case PRJ_CAPRICORN_5W:
			soc_type = "Capricorn(5W)";
			break;
		case PRJ_SCORPIO_ST:
			soc_type = "ZC551KL_ST";
			break;
		case PRJ_SCORPIO:
			soc_type = "ZC551KL_Scorpio";
			break;
		case PRJ_GEMINI_10W:
			soc_type = "Gemini(10W)";
			break;
...
void oem_get_sku_id_str(struct seq_file *s)
{
	const char* sku_info = "UNKNOWN";

	switch(g_ASUS_RF_SKU){
		case EVB_NONE:
			sku_info = "EVB_NONE";
			break;
		case SKU1_WW:
...
void oem_get_stage_str(struct seq_file *s)
{
	...
	seq_printf(s, "Board Stage: %s\n", stage_info);
}

void oem_get_cputype_str(struct seq_file *s)
{
	const char* cputype_info = "UNKNOWN";

	switch(g_ASUS_PRJ_CPUTYPE){
		case CPUTYPE_MSM8917:
			cputype_info = "MSM8917";
			break;
		case CPUTYPE_MSM8937:
			cputype_info = "MSM8937";
			break;
		default:
			cputype_info = "Unknown";
			break;
	}

	seq_printf(s, "Cpu Type: %s\n", cputype_info);
}
