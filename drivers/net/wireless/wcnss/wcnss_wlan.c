...
#define NVBIN_FILE_SCORPIO_US "wlan/prima/WCNSS_qcom_wlan_nv_scorpio_US.bin"
#define NVBIN_FILE_SCORPIO_WW "wlan/prima/WCNSS_qcom_wlan_nv_scorpio_WW.bin"
...
static void wcnss_nvbin_dnld(void)
{
	...
	if(PRJ_SCORPIO_ST == g_ASUS_PRJ_ID || PRJ_SCORPIO == g_ASUS_PRJ_ID){
          if(SKU4_US_BR == g_ASUS_RF_SKU)
		    NVBIN_FILE = NVBIN_FILE_SCORPIO_US;
          else
		    NVBIN_FILE = NVBIN_FILE_SCORPIO_WW;
       }	
	else
