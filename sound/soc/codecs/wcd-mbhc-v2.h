...
struct wcd_mbhc {
	...
	struct notifier_block nblock;
	struct dentry *debugfs_mbhc;  //ASUS_BSP +++ tyree_liu add mbhc node for BMMI
...
void wcd_mbhc_plug_detect_for_debug_mode(struct wcd_mbhc *mbhc, int debug_mode); /* ASUS_BSP mei_huang +++ */
