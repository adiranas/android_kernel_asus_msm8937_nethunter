...
enum qpnp_adc_scale_fn_type {
	...
	ASUS_SCALE_SMBCHG_TEMP,//bsp add guochang_qiu add smbchg chan
	SCALE_NONE,
};
...
int32_t asus_qpnp_adc_scale_smbchg_temp(struct qpnp_vadc_chip *dev,
			int32_t adc_code,
			const struct qpnp_adc_properties *adc_prop,
			const struct qpnp_vadc_chan_properties *chan_prop,
			struct qpnp_vadc_result *chan_rslt);
...
//add bsp guochang_qiu for smbchg chan+++
static inline int32_t asus_qpnp_adc_scale_smbchg_temp(struct qpnp_vadc_chip *vadc,
			int32_t adc_code,
			const struct qpnp_adc_properties *adc_prop,
			const struct qpnp_vadc_chan_properties *chan_prop,
			struct qpnp_vadc_result *chan_rslt)
