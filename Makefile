...
#ASUS_BSP Ander: ZC600KL support ZD551KL mutliple panel build +++
ifeq ($(ASUS_TOUCH_PANEL), JTOUCH)
	KBUILD_CPPFLAGS += -DASUS_JTOUCH=1
endif
# ASUS_BSP Ander : ZC600KL support ZD551KL mutliple panel build ---
...
ifndef TOUCHSCREEN_GT9XX_DRIVER_USED
KBUILD_CPPFLAGS += -DTOUCHSCREEN_GT9XX_DRIVER_USED
endif
